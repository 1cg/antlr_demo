// $ANTLR 3.5.2 Ruleb.g 2021-03-25 10:26:51
...
public class TParser_Ruleb extends AbstractTParser {
	...
	@Override public String getGrammarFileName() { return "Ruleb.g"; }
	...
	public final TParser_Ruleb.b_return b() throws RecognitionException {
		...
		Token SEMI2=null;
		Token SEMI4=null;
		ParserRuleReturnScope keyser1 =null;
		...
		try {
			...
			else if ( ((LA1_0 >= ID && LA1_0 <= INT)||LA1_0==STRING) ) {
				alt1=2;
			}
