// $ANTLR 3.5.2 org/example/TParser.g 2021-03-25 10:26:51
...
public class TParser extends AbstractTParser {
	...
	@Override public String getGrammarFileName() { return "org/example/TParser.g"; }
	...
	// $ANTLR start "a"
	// org/example/TParser.g:53:1: a : ( b )* EOF -> ^( SCRIPT ( b )* ) ;
	public final TParser.a_return a() throws RecognitionException {
		...
		try {
			// org/example/TParser.g:53:4: ( ( b )* EOF -> ^( SCRIPT ( b )* ) )
			// org/example/TParser.g:53:6: ( b )* EOF
			{
			// org/example/TParser.g:53:6: ( b )*
			loop1:
			while (true) {
				int alt1=2;
				int LA1_0 = input.LA(1);
				if ( ((LA1_0 >= ID && LA1_0 <= KEYSER)||LA1_0==STRING) ) {
					alt1=1;
				}
	...
	// $ANTLR start "keyser"
	// org/example/TParser.g:60:1: keyser : KEYSER ^ SOZE ;
	...
	// org/example/TParser.g:64:1: expression : addExpr ( ADD ^ addExpr )* ;
	public final TParser.expression_return expression() throws RecognitionException {
		...
		ParserRuleReturnScope addExpr7 =null;

		Object ADD6_tree=null;

		try {
			// org/example/TParser.g:65:4: ( addExpr ( ADD ^ addExpr )* )
			// org/example/TParser.g:65:6: addExpr ( ADD ^ addExpr )*
			{
			root_0 = (Object)adaptor.nil();
			...
			// org/example/TParser.g:65:14: ( ADD ^ addExpr )*
			loop2:
			while (true) {
				int alt2=2;
				...
				switch (alt2) {
				case 1 :
					// org/example/TParser.g:65:15: ADD ^ addExpr
					{
					ADD6=(Token)match(input,ADD,FOLLOW_ADD_in_expression239); 
					ADD6_tree = (Object)adaptor.create(ADD6);
	...
	// $ANTLR start "addExpr"
	// org/example/TParser.g:68:1: addExpr : ( ID | INT | STRING );
	public final TParser.addExpr_return addExpr() throws RecognitionException {
		...
		try {
			// org/example/TParser.g:69:4: ( ID | INT | STRING )
			// org/example/TParser.g:
			{
			root_0 = (Object)adaptor.nil();
